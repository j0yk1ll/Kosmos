...
class TestREQ_ENV_001_StableReproducibleEnvironment:
    ...
    def test_python_version_consistency(self):
        ...
        ), f"Must use Python 3.8+, got {version_info.major}.{version_info.minor}"
    ...
    def test_pyproject_toml_exists(self):
        ...
        assert (
            "[project]" in content or "[tool.poetry]" in content
    ...
    def test_kosmos_package_importable(self):
        ...
        try:
            ...
            assert hasattr(kosmos, "__version__") or hasattr(
                kosmos, "__file__"
...
class TestREQ_ENV_002_ContainerizedDeployment:
    ...
    def test_containerized_paths_absolute(self):
        ...
        with patch.dict(
            os.environ, {"ANTHROPIC_API_KEY": "test_key", "DATABASE_URL": "sqlite:///kosmos.db"}
        ):
...
class TestREQ_ENV_005_GracefulMissingDependencies:
    ...
    def test_optional_dependency_detection(self):
        ...
        optional_deps = ["plotly", "seaborn", "networkx", "rpy2"]
    ...
    def test_feature_flags_for_optional_features(self):
        ...
        with patch.dict(
            os.environ, {"ANTHROPIC_API_KEY": "test_key", "VECTOR_DB_TYPE": "chromadb"}
        ):
            config = get_config(reload=True)
...
class TestREQ_ENV_006_MetabolomicsLibraries:
    ...
    def test_metabolomics_fallback_functionality(self):
        ...
        print(
            f"Metabolomics features: {'enabled' if has_metabolomics else 'disabled (fallback active)'}"
        )
...
class TestREQ_ENV_007_MaterialsScienceLibraries:
    ...
    def test_materials_science_domain_detection(self):
        ...
        with patch.dict(
            os.environ,
            {"ANTHROPIC_API_KEY": "test_key", "ENABLED_DOMAINS": "biology,physics,chemistry"},
        ):
            config = get_config(reload=True)
...
class TestEnvironmentIntegration:
    ...
    def test_environment_reproducibility(self):
        ...
        with patch.dict(os.environ, {"ANTHROPIC_API_KEY": "test_key_123", "LOG_LEVEL": "INFO"}):
