...
class TestGraphInfoCommand:
    ...
    def mock_world_model(self):
        ...
        mock_wm.get_statistics.return_value = {
            ...
            "annotation_count": 45,
            "entity_types": {"Paper": 50, "Concept": 40, "Method": 30, "Author": 30},
            "relationship_types": {
                "CITES": 100,
                "DESCRIBES": 80,
                "AUTHORED_BY": 50,
...
class TestGraphImportCommand:
    ...
    def sample_export_file(self, tmp_path):
        ...
        export_data = {
            ...
            "source": "kosmos",
            "statistics": {"nodes": 100, "relationships": 200},
            "nodes": [],
            "relationships": [],
        }
    ...
    def test_import_with_clear_flag(
        self, mock_confirm, mock_get_wm, mock_world_model, runner, sample_export_file
    ):
    ...
    @patch("kosmos.world_model.get_world_model")
    @patch("kosmos.cli.commands.graph.confirm_action")
    def test_import_clear_cancellation(
        self, mock_confirm, mock_get_wm, mock_world_model, runner, sample_export_file
    ):
    ...
    @patch("kosmos.world_model.get_world_model")
    def test_import_shows_statistics(
        self, mock_get_wm, mock_world_model, runner, sample_export_file
    ):
