...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "profile_type", sa.String(length=50), nullable=False
    ...
    op.create_index(
        "idx_execution_profiles_profile_type", "execution_profiles", ["profile_type"], unique=False
    )
    op.create_index(
        "idx_execution_profiles_created_at", "execution_profiles", ["created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_execution_profiles_memory_peak", "execution_profiles", ["memory_peak_mb"], unique=False
    )
    ...
    op.create_index(
        "idx_profiling_bottlenecks_severity", "profiling_bottlenecks", ["severity"], unique=False
    )
    op.create_index(
