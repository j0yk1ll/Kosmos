...
def setup_logging(
    ...
    root_logger.info(
        "Logging initialized",
        extra={"level": level, "format": log_format, "file": log_file, "debug_mode": debug_mode},
    )
...
class ExperimentLogger:
    ...
    def log_hypothesis(self, hypothesis: str):
        ...
        self.logger.info(
            f"Hypothesis: {hypothesis}", extra={"experiment_id": self.experiment_id, **event}
        )
    ...
    def log_experiment_design(self, design: dict[str, Any]):
        ...
        self.events.append(event)
        self.logger.info(
            "Experiment design created", extra={"experiment_id": self.experiment_id, **event}
        )
